...
func chat(_messages: Array, _model = null): #chat api uses context and is passed an array
	#print("Chat sent!")
...
func generate(_message: String, _model = null): #generate api doesnt use context
	if(_model==null): _model = model 
